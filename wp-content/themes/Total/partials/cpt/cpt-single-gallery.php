...
$slider_data_args = array(
	'filter_tag' => 'wpex_'. $type .'_single_gallery',
);

// Thumbnail args
$thumb_args = apply_filters( 'wpex_'. $type .'_single_thumbnail_args', array(
	'size'          => $type .'_single',
	'schema_markup' => true,
) ); ?>
...
<div id="post-media" class="wpex-clr">
	...
	<div id="cpt-single-gallery" class="cpt-post-slider wpex-clr">
		...
		<div class="wpex-slider slider-pro" <?php wpex_slider_data( $slider_data_args ); ?>>
			...
			if ( apply_filters( 'wpex_'. $type .'_gallery_slider_has_thumbnails', true ) ) : ?>
