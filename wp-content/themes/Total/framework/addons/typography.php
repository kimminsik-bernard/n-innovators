...
if ( ! class_exists( 'WPEX_Typography' ) ) {
	...
	class WPEX_Typography {
		...
		public static function register ( $wp_customize ) {
			...
			$s_family         = esc_html__( 'Font Family', 'total' );
			$s_style          = esc_html__( 'Font Style', 'total' );
			$s_default        = esc_html__( 'Default', 'total' );
			$s_xlight         = esc_html__( 'Extra Light: 100', 'total' );
			$s_light          = esc_html__( 'Light: 200', 'total' );
			$s_weight         = esc_html__( 'Font Weight', 'total' );
			$s_weight_desc    = esc_html__( 'Note: Not all Fonts support every font weight style.', 'total' );
			$s_300            = esc_html__( 'Book: 300', 'total' );
			$s_400            = esc_html__( 'Normal: 400', 'total' );
			$s_600            = esc_html__( 'Semibold: 600', 'total' );
			$s_700            = esc_html__( 'Bold: 700', 'total' );
			$s_800            = esc_html__( 'Extra Bold: 800', 'total' );
			$s_normal         = esc_html__( 'Normal', 'total' );
			$s_italic         = esc_html__( 'Italic', 'total' );
			$s_capitalize     = esc_html__( 'Capitalize', 'total' );
			$s_lowercase      = esc_html__( 'Lowercase', 'total' );
			$s_uppercase      = esc_html__( 'Uppercase', 'total' );
			$s_em_px          = esc_html__( 'Value in px or em.', 'total' );
			$s_transform      = esc_html__( 'Text Transform', 'total' );
			$s_size           = esc_html__( 'Font Size', 'total' );
			$s_color          = esc_html__( 'Font Color', 'total' );
			$s_line_height    = esc_html__( 'Line Height', 'total' );
			$s_letter_spacing = esc_html__( 'Letter Spacing', 'total' );
			$s_margin         = esc_html__( 'Margin', 'total' );
			$s_margin_desc    = esc_html__( 'Please use the following format: top right bottom left.', 'total' );
