	...
	class WPEX_Term_Thumbnails {
		...
		public static function admin_init() {
			...
			foreach ( $taxonomies as $taxonomy ) {
				...
				// Add forms
				add_action( $taxonomy . '_add_form_fields', array( 'WPEX_Term_Thumbnails', 'add_form_fields' ), 10 );
				add_action( $taxonomy . '_edit_form_fields', array( 'WPEX_Term_Thumbnails', 'edit_form_fields' ), 10, 2 );
