...
if ( ! class_exists( 'VCEX_Pricing_Shortcode' ) ) {
	...
	class VCEX_Pricing_Shortcode {
		...
		public static function map() {
			...
			$s_plan     = esc_html__( 'Plan', 'total' );
			$s_cost     = esc_html__( 'Cost', 'total' );
			$s_per      = esc_html__( 'Per', 'total' );
			$s_features = esc_html__( 'Features', 'total' );
			$s_button   = esc_html__( 'Button', 'total' );
				...
				'params' => array(
					...
					array(
						...
						'value' => array(
							...
							esc_html__( 'Inline-Block', 'total' ) => 'inline-block',
						),
						'group' => $s_per,
