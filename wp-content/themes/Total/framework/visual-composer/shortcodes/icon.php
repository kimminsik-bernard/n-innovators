				...
				'params' => array(
					...
					array(
						...
						'value' => array(
							...
							esc_html__( 'Mono Social', 'total' ) => 'monosocial',
						),
					),
					array(
						'type' => 'iconpicker',
					...
					array(
						...
						'std' => 'normal',
						'value' => array(
							esc_html__( 'Inherit', 'total' ) => 'inherit',
							esc_html__( 'Extra Large', 'total' ) => 'xlarge',
							esc_html__( 'Large', 'total' ) => 'large',
							esc_html__( 'Normal', 'total' ) => 'normal',
							esc_html__( 'Small', 'total') => 'small',
							esc_html__( 'Tiny', 'total' ) => 'tiny',
						),
						'group' => esc_html__( 'Design', 'total' ),
					),
					array(
					...
					array(
						...
						'value' => array(
							esc_html__( 'False', 'total' ) => 'false',
							esc_html__( 'True', 'total' ) => 'true',
						),
						'group' => esc_html__( 'Link', 'total' ),
					),
				)
