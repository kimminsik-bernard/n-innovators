...
if ( ! class_exists( 'VCEX_VC_Row_Config' ) ) {
	...
	class VCEX_VC_Row_Config {
		...
		public function __construct() {
			...
			if ( is_admin() ) {
				add_action( 'vc_after_init', array( 'VCEX_VC_Row_Config', 'update_params' ) );
			}

			// Add new parameters to the row
			add_action( 'init', array( 'VCEX_VC_Row_Config', 'add_remove_params' ) );
		 ...
		 * @since 3.0.0
		 */
		public static function update_params() {
		...
		public static function add_remove_params() {
			...
			$add_params['columns_right'] = array(
				'type' => 'dropdown',
			...
			$add_params['offset_overlay_header'] = array(
				'type' => 'dropdown',
