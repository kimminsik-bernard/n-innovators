 ...
 * @since 3.5.0
 */
function wpex_get_template_part( $slug = '', $name = '', $refresh_wrap = false ) {
	if ( $slug ) {
...
function wpex_single_blocks() {
	...
	// Needed because of plugins using archives such as bbPress - zzz
...
function wpex_placeholder_img_src() {
	return esc_url( apply_filters( 'wpex_placeholder_img_src', wpex_asset_url( '/images/placeholder.png' ) ) );
}
